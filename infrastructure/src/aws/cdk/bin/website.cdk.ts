...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////// CREATE ACM CERTIFICATE IF CUSTOM DOMAIN IS ENABLED
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const websiteStack = new StaticWebsiteStack(app, `${stackPrefix}-static`, {
  ...
  ssmParams: {
    cloudFrontDistributionId: config.aws.ssm.cloudFrontDistributionIdSsmParam,
    s3BucketName: config.aws.ssm.s3BucketNameSsmParam,
  },
  tags: config.tags,
});

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////// SETUP DNS MAPPING IN ROUTE53
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if (config.features.useCustomDomain) {
  const dnsStack = new DnsStack(app, `${stackPrefix}-dns`, {
    ...
    hostedZoneId: ssmStack.hostedZoneId,
    distribution: config.features.useCloudFront
      ? websiteStack.distribution
      : undefined,
